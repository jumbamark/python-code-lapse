...
The "name" variable belongs to the object(assigned using self) and hence is an object variable
We refer to the "population" class variable as "Robot.population"
We refer to the object variable "name" using self.name notation in the methods of that object
An object variable with the same name as class variable will hide the class variables
"""
